...
const shortAnswerLessonSchema = z.object({
  ...
  info: z.string().optional().describe("A one sentence hint that does not reveal the answer"),
...
export const flowQuestionSchema = z.object({
  ...
  info: z.string().optional().describe("A one sentence hint that does not reveal the ordered answer"),
  question: z
    .string()
